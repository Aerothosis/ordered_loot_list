                        ...
                        args   = {
                            ...
                            lootCountGroup = {
                                ...
                                args   = {
                                    ...
                                    tokensCountAsLoot = {
                                        type     = "toggle",
                                        name     = "Tier tokens count toward loot count",
                                        desc     = "Tier / catalyst tokens are rolled through OLL like gear. When enabled, winning one increments the winner's loot count. Cannot be changed during an active session.",
                                        get      = function() return ns.db.profile.tokensCountAsLoot == true end,
                                        set      = function(_, v) ns.db.profile.tokensCountAsLoot = v end,
                                        hidden   = function() return ns.db.profile.lootCountEnabled == false end,
                                        disabled = function() return ns.Session and ns.Session:IsActive() end,
                                        order    = 2.1,
                                        width    = "full",
                                    ...
                                    recipesCountAsLoot = {
                                        type     = "toggle",
                                        name     = "Recipes count toward loot count",
                                        desc     = "Profession recipes are rolled through OLL like gear. When enabled, winning one increments the winner's loot count. Cannot be changed during an active session.",
                                        get      = function() return ns.db.profile.recipesCountAsLoot == true end,
                                        set      = function(_, v) ns.db.profile.recipesCountAsLoot = v end,
                                        hidden   = function() return ns.db.profile.lootCountEnabled == false end,
                                        disabled = function() return ns.Session and ns.Session:IsActive() end,
                                        order    = 2.2,
                                        width    = "full",
